...
namespace Simtabi\Laranail\Nails\Archivable\Traits;
namespace Simtabi\Laranail\Nails\Archiver\Traits;

use Closure;
use Exception;
use Simtabi\Laranail\Nails\Archiver\Scopes\Archiver;
...
trait HasArchiver
{
    ...
    {
        static::addGlobalScope(new Archiver());
    }
