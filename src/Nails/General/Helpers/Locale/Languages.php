...
class Languages
{
    ...
    {
        $languages = [];
        $locales = scanFolder(resource_path('lang'));
        if (in_array('vendor', $locales)) {
            $locales = array_merge($locales, scanFolder(resource_path('lang/vendor')));
        }
        ...
        foreach ($locales as $locale) {
            ...
            foreach (Languages::getListLanguages() as $key => $language) {
